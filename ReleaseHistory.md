...
* BUG: `SARIF1001.RuleIdentifiersMustBeValid` now exempts AI-origin runs (`properties["ai/origin"]` set) from the case-fold-equality check on notification descriptors, matching `SARIF2009`. Strict-identical `id`/`name` pairs still fire universally.
