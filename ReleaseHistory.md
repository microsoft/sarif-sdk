...
* BUG: `AI1003.ProvideRequiredRegionProperties` accepts a `region` expressed as char-offset or byte-offset (SARIF §3.30), matching `SARIF2017`, instead of faulting any region that lacks `startLine`.
