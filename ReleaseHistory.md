...
* BRK: `multitool add-reporting-descriptor --rules` now gates the descriptor `id` against the full `NOVEL-` grammar (`NOVEL-` followed by a lowercase-alphanumeric kebab sub-id) rather than the `NOVEL-` prefix alone.
