...
* NEW: The embedded CWE taxonomy's `shortDescription` is now the first sentence of the MITRE `<Description>` (verbatim, not paraphrased) rather than the full multi-sentence text; the complete Description is retained in `help.text`.
