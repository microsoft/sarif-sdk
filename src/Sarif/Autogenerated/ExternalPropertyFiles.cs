...
namespace Microsoft.CodeAnalysis.Sarif
{
    ...
    public partial class ExternalPropertyFiles : PropertyBagHolder, ISarifNode
    {
        ...
        /// </param>
        public ExternalPropertyFiles(ExternalPropertyFile conversion, ExternalPropertyFile graphs, ExternalPropertyFile resources, IEnumerable<ExternalPropertyFile> files, IEnumerable<ExternalPropertyFile> invocations, IEnumerable<ExternalPropertyFile> logicalLocations, IEnumerable<ExternalPropertyFile> results, IDictionary<string, SerializedPropertyInfo> properties)
        {
            Init(conversion, graphs, resources, files, invocations, logicalLocations, results, properties);
        }
        ...
        public ExternalPropertyFiles(ExternalPropertyFiles other)
        {
            ...
            Init(other.Conversion, other.Graphs, other.Resources, other.Files, other.Invocations, other.LogicalLocations, other.Results, other.Properties);
        }
