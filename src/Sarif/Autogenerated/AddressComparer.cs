...
namespace Microsoft.CodeAnalysis.Sarif
{
    ...
    internal sealed class AddressComparer : IComparer<Address>
    {
        ...
        public int Compare(Address left, Address right)
        {
            ...
            // TryReferenceCompares is an autogenerated extension method
            // that will properly handle the case when 'left' is null.
            if (left.RelativeAddress.TryReferenceCompares(right.RelativeAddress, out compareResult) && compareResult != 0)
            {
                return compareResult;
            }
            ...
            // TryReferenceCompares is an autogenerated extension method
            // that will properly handle the case when 'left' is null.
            if (left.Length.TryReferenceCompares(right.Length, out compareResult) && compareResult != 0)
            {
                return compareResult;
            }
            ...
            // TryReferenceCompares is an autogenerated extension method
            // that will properly handle the case when 'left' is null.
            if (left.OffsetFromParent.TryReferenceCompares(right.OffsetFromParent, out compareResult) && compareResult != 0)
            {
                return compareResult;
            }
