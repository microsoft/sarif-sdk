...
namespace Microsoft.CodeAnalysis.Sarif
{
    ...
    public partial class Address : PropertyBagHolder, ISarifNode
    {
        ...
        public virtual BigInteger AbsoluteAddress { get; set; }
        ...
        [JsonProperty(DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate)]
        public virtual BigInteger? RelativeAddress { get; set; } // NOTYETAUTOGENERATED: Property should be nullable int. https://github.com/Microsoft/jschema/issues/112

        /// <summary>
        /// The number of bytes in this range of addresses.
        /// </summary>
        [DataMember(Name = "length", IsRequired = false, EmitDefaultValue = false)]
        public virtual BigInteger? Length { get; set; } // NOTYETAUTOGENERATED: Property should be nullable int. https://github.com/Microsoft/jschema/issues/112
        ...
        public virtual BigInteger? OffsetFromParent { get; set; } // NOTYETAUTOGENERATED: Property should be nullable int. https://github.com/Microsoft/jschema/issues/112
        ...
        /// </param>
        public Address(BigInteger absoluteAddress, BigInteger? relativeAddress, BigInteger? length, string kind, string name, string fullyQualifiedName, BigInteger? offsetFromParent, int index, int parentIndex, IDictionary<string, SerializedPropertyInfo> properties)
        {
        ...
        protected virtual void Init(BigInteger absoluteAddress, BigInteger? relativeAddress, BigInteger? length, string kind, string name, string fullyQualifiedName, BigInteger? offsetFromParent, int index, int parentIndex, IDictionary<string, SerializedPropertyInfo> properties)
        {
