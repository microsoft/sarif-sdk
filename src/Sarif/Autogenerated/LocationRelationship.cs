...
namespace Microsoft.CodeAnalysis.Sarif
{
    ...
    public partial class LocationRelationship : PropertyBagHolder, ISarifNode
    {
        ...
        /// </param>
        public LocationRelationship(int target, IEnumerable<string> kinds, IDictionary<string, SerializedPropertyInfo> properties)
        {
        ...
        private void Init(int target, IEnumerable<string> kinds, IDictionary<string, SerializedPropertyInfo> properties)
        {
            Target = target;
            if (kinds != null)
            {
