...
namespace Microsoft.CodeAnalysis.Sarif
{
    ...
    public sealed class LogicalLocationComponentEqualityComparer : IEqualityComparer<LogicalLocationComponent>
    {
        public static readonly LogicalLocationComponentEqualityComparer Instance = new LogicalLocationComponentEqualityComparer();
