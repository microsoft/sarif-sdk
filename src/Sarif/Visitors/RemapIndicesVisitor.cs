...
namespace Microsoft.CodeAnalysis.Sarif.Visitors
{
    ...
    public class RemapIndicesVisitor : SarifRewritingVisitor
    {
        ...
        {
            if (node.LogicalLocation != null && node.LogicalLocation.ParentIndex != -1 && HistoricalLogicalLocations != null)
            {
                LogicalLocation logicalLocation = HistoricalLogicalLocations[node.LogicalLocation.ParentIndex];
                ...
                node.LogicalLocation.ParentIndex = remappedIndex;
            }
