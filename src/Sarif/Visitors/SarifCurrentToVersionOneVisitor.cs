    ...
    public class SarifCurrentToVersionOneVisitor : SarifRewritingVisitor
    {
        ...
        internal LocationVersionOne CreateLocationVersionOne(Location v2Location)
        {
            ...
            if (v2Location != null)
            {
                ...
                {
                    if (v2Location.LogicalLocation.ParentIndex != -1)
                    {
                        location.DecoratedName = _currentV2Run.LogicalLocations[v2Location.LogicalLocation.ParentIndex].DecoratedName;
                    }
                }
            }
            ...
            if (v2StackFrame != null)
            {
                ...
                if (location != null)
                {
                    ...
                    if (_currentV2Run.LogicalLocations != null &&
                        ...
                        !string.IsNullOrWhiteSpace(_currentV2Run.LogicalLocations[location.LogicalLocation.ParentIndex].FullyQualifiedName))
                    {
                        stackFrame.FullyQualifiedLogicalName = _currentV2Run.LogicalLocations[location.LogicalLocation.ParentIndex].FullyQualifiedName;
                        stackFrame.LogicalLocationKey = fqln != _currentV2Run.LogicalLocations[location.LogicalLocation.ParentIndex].FullyQualifiedName ? fqln : null;
                    }
                    else
                    {
