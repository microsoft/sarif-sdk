...
{
    public class EnumConverterVersionOne : JsonConverter
    {
        public static readonly EnumConverterVersionOne Instance = new EnumConverterVersionOne();
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                value = Enum.GetName(objectType, reader.Value);
            }
            else
            {
