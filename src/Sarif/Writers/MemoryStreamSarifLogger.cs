...
namespace Microsoft.CodeAnalysis.Sarif.Writers
{
    public class MemoryStreamSarifLogger : SarifLogger
    {
        ...
        public MemoryStreamSarifLogger(FilePersistenceOptions logFilePersistenceOptions = FilePersistenceOptions.PrettyPrint,
                                       ...
                                       int resultsLimitPerRuleTarget = 0) : this(new StreamWriter(new MemoryStream()),
        ...
        public MemoryStreamSarifLogger(StreamWriter writer,
                                       ...
                                       ResultKindSet kinds = null,
                                       IEnumerable<string> insertProperties = null,
                                       int resultsLimitPerRuleTarget = 0) : base(writer,
                                                                                 logFilePersistenceOptions,
                                                                                 dataToInsert,
                                                                                 dataToRemove,
                                                                                 run,
                                                                                 ...
                                                                                 resultsLimitPerRuleTarget: resultsLimitPerRuleTarget)
        {
            if (writer == null)
            {
