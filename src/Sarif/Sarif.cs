...
//     Input Grammar      : Sarif
//     Input Grammar file : G:\Code\sarif-sdk\src\Sarif\GrammarFiles\Sarif.g4
//     
...
namespace Microsoft.CodeAnalysis.Sarif
{
    ...
    public enum SarifKind
    {
        ...
        /// <summary>An entry indicating that the <see cref="ISyntax" /> object is of type PhysicalLocation.</summary>
        PhysicalLocation,
    ...
    /// <summary>An interface for all types generated from the grammar Sarif.</summary>
    ...
    public sealed class AnnotatedCodeLocation : ISyntax, IEquatable<AnnotatedCodeLocation>
    {
        /// <summary>Gets the kind of type implementing <see cref="ISyntax" />.</summary>
        /// <value>The enumeration value for the kind of type implementing <see cref="ISyntax" />.</value>
        public SarifKind SyntaxKind { get { return SarifKind.AnnotatedCodeLocation; } }
        ...
        private void Init(PhysicalLocation physicalLocationArg, string messageArg)
        {
            if (physicalLocationArg != null)
            {
                this.PhysicalLocation = new PhysicalLocation(physicalLocationArg);
            }
            if (messageArg != null)
            {
        ...
        public AnnotatedCodeLocation(PhysicalLocation physicalLocationArg, string messageArg)
        {
            this.Init(
                physicalLocationArg, 
                messageArg
        ...
        public override int GetHashCode()
        {
            ...
            unchecked
            {
                ...
                {
                    result = (result * 31) + this.PhysicalLocation.GetHashCode();
                }
        ...
        public bool Equals(AnnotatedCodeLocation other)
        {
            ...
            if (!global::System.Object.Equals(this.PhysicalLocation, other.PhysicalLocation))
            {
                return false;
            }
    ...
    public sealed class FileChange : ISyntax, IEquatable<FileChange>
    {
        /// <summary>Gets the kind of type implementing <see cref="ISyntax" />.</summary>
        /// <value>The enumeration value for the kind of type implementing <see cref="ISyntax" />.</value>
        public SarifKind SyntaxKind { get { return SarifKind.FileChange; } }
    ...
    public sealed class FileReference : ISyntax, IEquatable<FileReference>
    {
        /// <summary>Gets the kind of type implementing <see cref="ISyntax" />.</summary>
        /// <value>The enumeration value for the kind of type implementing <see cref="ISyntax" />.</value>
        public SarifKind SyntaxKind { get { return SarifKind.FileReference; } }
        ...
        private void Init(global::System.Uri uriArg, string mimeTypeArg, IEnumerable<Hash> hashesArg, global::System.Collections.Generic.Dictionary<string, string> propertiesArg, IEnumerable<string> tagArg)
        {
            if (uriArg != null)
            {
                this.Uri = new global::System.Uri(uriArg.OriginalString, uriArg.IsAbsoluteUri ? global::System.UriKind.Absolute : global::System.UriKind.Relative);
        ...
        public FileReference(global::System.Uri uriArg, string mimeTypeArg, IEnumerable<Hash> hashesArg, global::System.Collections.Generic.Dictionary<string, string> propertiesArg, IEnumerable<string> tagArg)
        {
            this.Init(
                uriArg, 
                mimeTypeArg, 
        ...
        public override int GetHashCode()
        {
            ...
            unchecked
            {
                ...
                if (this.Properties != null)
                {
                    ...
                    int xor_0 = 0;
                    foreach (var value_1 in this.Properties)
                    {
                        xor_0 ^= (value_1.Key ?? String.Empty).GetHashCode();
                        xor_0 ^= (value_1.Value ?? String.Empty).GetHashCode();
                    }
                ...
                if (this.Tag != null)
                {
                    foreach (var value_2 in this.Tag)
                    {
                        result = result * 31;
                        if (value_2 != null)
                        {
        ...
        public bool Equals(FileReference other)
        {
            ...
            if (!global::System.Object.ReferenceEquals(this.Hashes, other.Hashes))
            {
                ...
                for (int index_0 = 0; index_0 < max_0; ++index_0)
                {
                    var value_3 = this.Hashes[index_0];
                    var value_4 = other.Hashes[index_0];
                    if (!global::System.Object.Equals(value_3, value_4))
                    {
                        return false;
                    }
                }
            ...
            if (!global::System.Object.ReferenceEquals(this.Properties, other.Properties))
            {
                ...
                {
                    string value_6;
                    if (!other.Properties.TryGetValue(value_5.Key, out value_6) || !global::System.Object.Equals(value_5.Value, value_6))
                    {
                        return false;
                    }
                }
            ...
            if (!global::System.Object.ReferenceEquals(this.Tag, other.Tag))
            {
                ...
                if (this.Tag.Count != other.Tag.Count)
                {
                    return false;
                }

                int max_1 = this.Tag.Count;
                for (int index_1 = 0; index_1 < max_1; ++index_1)
                {
                    var value_7 = this.Tag[index_1];
                    var value_8 = other.Tag[index_1];
                    if (value_7 != value_8)
                    {
                        return false;
                    }
    ...
    public sealed class Fix : ISyntax, IEquatable<Fix>
    {
        /// <summary>Gets the kind of type implementing <see cref="ISyntax" />.</summary>
        /// <value>The enumeration value for the kind of type implementing <see cref="ISyntax" />.</value>
        public SarifKind SyntaxKind { get { return SarifKind.Fix; } }
    ...
    public sealed class FormattedMessage : ISyntax, IEquatable<FormattedMessage>
    {
        /// <summary>Gets the kind of type implementing <see cref="ISyntax" />.</summary>
        /// <value>The enumeration value for the kind of type implementing <see cref="ISyntax" />.</value>
        public SarifKind SyntaxKind { get { return SarifKind.FormattedMessage; } }
    ...
    public sealed class Hash : ISyntax, IEquatable<Hash>
    {
        /// <summary>Gets the kind of type implementing <see cref="ISyntax" />.</summary>
        /// <value>The enumeration value for the kind of type implementing <see cref="ISyntax" />.</value>
        public SarifKind SyntaxKind { get { return SarifKind.Hash; } }
    ...
    public sealed class Location : ISyntax, IEquatable<Location>
    {
        /// <summary>Gets the kind of type implementing <see cref="ISyntax" />.</summary>
        /// <value>The enumeration value for the kind of type implementing <see cref="ISyntax" />.</value>
        public SarifKind SyntaxKind { get { return SarifKind.Location; } }
        ...
        private void Init(PhysicalLocation analysisTargetArg, PhysicalLocation resultFileArg, IEnumerable<LogicalLocationComponent> logicalLocationArg, string fullyQualifiedLogicalNameArg, global::System.Collections.Generic.Dictionary<string, string> propertiesArg, IEnumerable<string> tagArg)
        {
            if (analysisTargetArg != null)
            {
                this.AnalysisTarget = new PhysicalLocation(analysisTargetArg);
            }
            if (resultFileArg != null)
            {
                this.ResultFile = new PhysicalLocation(resultFileArg);
            }
            if (logicalLocationArg != null)
            {
                ...
                if (logicalLocationArg != null)
                {
                    foreach (var value_0 in logicalLocationArg)
                    {
                        if (value_0 == null)
                        {
                            destination_0.Add(null);
                ...
                this.LogicalLocation = destination_0;
            }
        ...
        /// <param name="propertiesArg">An initialization value for the <see cref="P:Properties" /> member.</param>
        /// <param name="tagArg">An initialization value for the <see cref="P:Tag" /> member.</param>
        public Location(PhysicalLocation analysisTargetArg, PhysicalLocation resultFileArg, IEnumerable<LogicalLocationComponent> logicalLocationArg, string fullyQualifiedLogicalNameArg, global::System.Collections.Generic.Dictionary<string, string> propertiesArg, IEnumerable<string> tagArg)
        {
            this.Init(
                analysisTargetArg, 
                resultFileArg, 
        ...
        public override int GetHashCode()
        {
            ...
            unchecked
            {
                ...
                {
                    result = (result * 31) + this.AnalysisTarget.GetHashCode();
                }
                if (this.ResultFile != null)
                {
                    result = (result * 31) + this.ResultFile.GetHashCode();
                }
                if (this.LogicalLocation != null)
                {
                    foreach (var value_0 in this.LogicalLocation)
                    {
                        result = result * 31;
                        if (value_0 != null)
                        {
        ...
        public bool Equals(Location other)
        {
            ...
            if (!global::System.Object.Equals(this.AnalysisTarget, other.AnalysisTarget))
            {
                return false;
            }

            if (!global::System.Object.Equals(this.ResultFile, other.ResultFile))
            {
                return false;
            }
            ...
            if (!global::System.Object.ReferenceEquals(this.LogicalLocation, other.LogicalLocation))
            {
                ...
                int max_0 = this.LogicalLocation.Count;
                for (int index_0 = 0; index_0 < max_0; ++index_0)
                {
                    var value_3 = this.LogicalLocation[index_0];
                    var value_4 = other.LogicalLocation[index_0];
                    if (!global::System.Object.Equals(value_3, value_4))
                    {
                        return false;
                    }
    ...
    public sealed class LogicalLocationComponent : ISyntax, IEquatable<LogicalLocationComponent>
    {
        /// <summary>Gets the kind of type implementing <see cref="ISyntax" />.</summary>
        /// <value>The enumeration value for the kind of type implementing <see cref="ISyntax" />.</value>
        public SarifKind SyntaxKind { get { return SarifKind.LogicalLocationComponent; } }
    ...
    [DataContract]
    [CompilerGenerated]
    public sealed class PhysicalLocation : ISyntax, IEquatable<PhysicalLocation>
    {
        /// <summary>Gets the kind of type implementing <see cref="ISyntax" />.</summary>
        /// <value>The enumeration value for the kind of type implementing <see cref="ISyntax" />.</value>
        public SarifKind SyntaxKind { get { return SarifKind.PhysicalLocation; } }
        ...
        private void Init(global::System.Uri uriArg, Region regionArg)
        {
            if (uriArg != null)
            {
                this.Uri = new global::System.Uri(uriArg.OriginalString, uriArg.IsAbsoluteUri ? global::System.UriKind.Absolute : global::System.UriKind.Relative);
        ...
        /// <summary>Initializes a new instance of the <see cref="PhysicalLocation" /> class.</summary>
        public PhysicalLocation()
        {
            // Blank on purpose
        }

        /// <summary>Initializes a new instance of the <see cref="PhysicalLocation" /> class with the supplied data.</summary>
        /// <param name="uriArg">An initialization value for the <see cref="P:Uri" /> member.</param>
        /// <param name="regionArg">An initialization value for the <see cref="P:Region" /> member.</param>
        public PhysicalLocation(global::System.Uri uriArg, Region regionArg)
        {
            this.Init(
                uriArg, 
                regionArg
        ...
        /// <summary>Initializes a new instance of the <see cref="PhysicalLocation" /> class as a copy of another instance.</summary>
        /// <exception cref="ArgumentNullException">Thrown if <paramref name="other" /> is null.</exception>
        /// <param name="other">The instance to copy.</param>
        ...
        {
            return (PhysicalLocation)this.DeepCloneCore();
        }
        ...
        public override bool Equals(object o)
        {
            return this.Equals(o as PhysicalLocation);
        }
    ...
    public sealed class Region : ISyntax, IEquatable<Region>
    {
        /// <summary>Gets the kind of type implementing <see cref="ISyntax" />.</summary>
        /// <value>The enumeration value for the kind of type implementing <see cref="ISyntax" />.</value>
        public SarifKind SyntaxKind { get { return SarifKind.Region; } }
        ...
        private void Init(int startLineArg, int startColumnArg, int endLineArg, int endColumnArg, int charOffsetArg, int byteOffsetArg, int lengthArg)
        {
            this.StartLine = startLineArg;
            this.StartColumn = startColumnArg;
            this.EndLine = endLineArg;
            this.EndColumn = endColumnArg;
            this.CharOffset = charOffsetArg;
            this.ByteOffset = byteOffsetArg;
        ...
        /// <param name="charOffsetArg">An initialization value for the <see cref="P:CharOffset" /> member.</param>
        /// <param name="byteOffsetArg">An initialization value for the <see cref="P:ByteOffset" /> member.</param>
        /// <param name="lengthArg">An initialization value for the <see cref="P:Length" /> member.</param>
        public Region(int startLineArg, int startColumnArg, int endLineArg, int endColumnArg, int charOffsetArg, int byteOffsetArg, int lengthArg)
        {
            this.Init(
                startLineArg, 
                startColumnArg, 
        ...
        public override int GetHashCode()
        {
            ...
            unchecked
            {
                ...
                result = (result * 31) + (int)this.CharOffset;
                result = (result * 31) + (int)this.ByteOffset;
    ...
    public sealed class Replacement : ISyntax, IEquatable<Replacement>
    {
        /// <summary>Gets the kind of type implementing <see cref="ISyntax" />.</summary>
        /// <value>The enumeration value for the kind of type implementing <see cref="ISyntax" />.</value>
        public SarifKind SyntaxKind { get { return SarifKind.Replacement; } }
    ...
    public sealed class Result : ISyntax, IEquatable<Result>
    {
        /// <summary>Gets the kind of type implementing <see cref="ISyntax" />.</summary>
        /// <value>The enumeration value for the kind of type implementing <see cref="ISyntax" />.</value>
        public SarifKind SyntaxKind { get { return SarifKind.Result; } }
        ...
        private void Init(string ruleIdArg, ResultKind kindArg, string fullMessageArg, string shortMessageArg, FormattedMessage formattedMessageArg, IEnumerable<Location> locationsArg, string toolFingerprintArg, IEnumerable<IEnumerable<AnnotatedCodeLocation>> stacksArg, IEnumerable<IEnumerable<AnnotatedCodeLocation>> executionFlowsArg, IEnumerable<AnnotatedCodeLocation> relatedLocationsArg, bool isSuppressedInSourceArg, IEnumerable<Fix> fixesArg, global::System.Collections.Generic.Dictionary<string, string> propertiesArg, IEnumerable<string> tagArg)
        {
            if (ruleIdArg != null)
            {
            ...
            if (relatedLocationsArg != null)
            {
                ...
                if (relatedLocationsArg != null)
                {
                    foreach (var value_5 in relatedLocationsArg)
                    {
                        if (value_5 == null)
                        {
                ...
                this.RelatedLocations = destination_5;
            }
            ...
            if (fixesArg != null)
            {
                ...
                if (fixesArg != null)
                {
                    foreach (var value_6 in fixesArg)
                    {
                        if (value_6 == null)
                        {
        ...
        /// <param name="propertiesArg">An initialization value for the <see cref="P:Properties" /> member.</param>
        /// <param name="tagArg">An initialization value for the <see cref="P:Tag" /> member.</param>
        public Result(string ruleIdArg, ResultKind kindArg, string fullMessageArg, string shortMessageArg, FormattedMessage formattedMessageArg, IEnumerable<Location> locationsArg, string toolFingerprintArg, IEnumerable<IEnumerable<AnnotatedCodeLocation>> stacksArg, IEnumerable<IEnumerable<AnnotatedCodeLocation>> executionFlowsArg, IEnumerable<AnnotatedCodeLocation> relatedLocationsArg, bool isSuppressedInSourceArg, IEnumerable<Fix> fixesArg, global::System.Collections.Generic.Dictionary<string, string> propertiesArg, IEnumerable<string> tagArg)
        {
            this.Init(
                ruleIdArg, 
                kindArg, 
        ...
        public override int GetHashCode()
        {
            ...
            unchecked
            {
                ...
                {
                    foreach (var value_5 in this.RelatedLocations)
                    {
                        result = result * 31;
                        if (value_5 != null)
                        {
                ...
                if (this.Fixes != null)
                {
                    foreach (var value_6 in this.Fixes)
                    {
                        result = result * 31;
                        if (value_6 != null)
                        {
                ...
                if (this.Properties != null)
                {
                    ...
                    {
                        xor_0 ^= (value_7.Key ?? String.Empty).GetHashCode();
                        xor_0 ^= (value_7.Value ?? String.Empty).GetHashCode();
                    }
                ...
                if (this.Tag != null)
                {
                    foreach (var value_8 in this.Tag)
                    {
                        result = result * 31;
                        if (value_8 != null)
                        {
        ...
        public bool Equals(Result other)
        {
            ...
            if (!global::System.Object.ReferenceEquals(this.Locations, other.Locations))
            {
                ...
                for (int index_0 = 0; index_0 < max_0; ++index_0)
                {
                    var value_9 = this.Locations[index_0];
                    var value_10 = other.Locations[index_0];
            ...
            if (!global::System.Object.ReferenceEquals(this.Stacks, other.Stacks))
            {
                ...
                for (int index_1 = 0; index_1 < max_1; ++index_1)
                {
                    var value_11 = this.Stacks[index_1];
                    var value_12 = other.Stacks[index_1];
                    if (!global::System.Object.ReferenceEquals(value_11, value_12))
                    {
                        ...
                        int max_2 = value_11.Count;
                        for (int index_2 = 0; index_2 < max_2; ++index_2)
                        {
                            var value_13 = value_11[index_2];
                            var value_14 = value_12[index_2];
            ...
            if (!global::System.Object.ReferenceEquals(this.ExecutionFlows, other.ExecutionFlows))
            {
                ...
                {
                    var value_15 = this.ExecutionFlows[index_3];
                    var value_16 = other.ExecutionFlows[index_3];
                    if (!global::System.Object.ReferenceEquals(value_15, value_16))
                    {
                        if (value_15 == null || value_16 == null)
                        {
                            return false;
                        }

                        if (value_15.Count != value_16.Count)
                        {
                            return false;
                        }

                        int max_4 = value_15.Count;
                        for (int index_4 = 0; index_4 < max_4; ++index_4)
                        {
                            var value_17 = value_15[index_4];
                            var value_18 = value_16[index_4];
            ...
            if (!global::System.Object.ReferenceEquals(this.RelatedLocations, other.RelatedLocations))
            {
                ...
                int max_5 = this.RelatedLocations.Count;
                for (int index_5 = 0; index_5 < max_5; ++index_5)
                {
                    var value_19 = this.RelatedLocations[index_5];
                    var value_20 = other.RelatedLocations[index_5];
                    if (!global::System.Object.Equals(value_19, value_20))
                    {
                        return false;
                    }
                }
            ...
            if (!global::System.Object.ReferenceEquals(this.Fixes, other.Fixes))
            {
                ...
                int max_6 = this.Fixes.Count;
                for (int index_6 = 0; index_6 < max_6; ++index_6)
                {
                    var value_21 = this.Fixes[index_6];
                    var value_22 = other.Fixes[index_6];
                    if (!global::System.Object.Equals(value_21, value_22))
                    {
                        return false;
                    }
                }
            ...
            if (!global::System.Object.ReferenceEquals(this.Properties, other.Properties))
            {
                ...
                foreach (var value_23 in this.Properties)
                {
                    string value_24;
                    if (!other.Properties.TryGetValue(value_23.Key, out value_24) || !global::System.Object.Equals(value_23.Value, value_24))
                    {
                        return false;
                    }
                }
            ...
            if (!global::System.Object.ReferenceEquals(this.Tag, other.Tag))
            {
                ...
                int max_7 = this.Tag.Count;
                for (int index_7 = 0; index_7 < max_7; ++index_7)
                {
                    var value_25 = this.Tag[index_7];
                    var value_26 = other.Tag[index_7];
                    if (value_25 != value_26)
                    {
                        return false;
                    }
                }
    ...
    [DataContract]
    [CompilerGenerated]
    public sealed class RuleDescriptor : IRuleDescriptor, ISyntax, IEquatable<RuleDescriptor>
    {
        /// <summary>Gets the kind of type implementing <see cref="ISyntax" />.</summary>
        /// <value>The enumeration value for the kind of type implementing <see cref="ISyntax" />.</value>
        public SarifKind SyntaxKind { get { return SarifKind.RuleDescriptor; } }
        ...
        public global::System.Uri HelpUri { get; set; }
        ...
        private void Init(string idArg, string nameArg, string shortDescriptionArg, string fullDescriptionArg, global::System.Collections.Generic.Dictionary<string, string> optionsArg, global::System.Collections.Generic.Dictionary<string, string> formatSpecifiersArg, global::System.Uri helpUriArg, global::System.Collections.Generic.Dictionary<string, string> propertiesArg, IEnumerable<string> tagArg)
        {
            ...
            if (helpUriArg != null)
            {
                this.HelpUri = new global::System.Uri(helpUriArg.OriginalString, helpUriArg.IsAbsoluteUri ? global::System.UriKind.Absolute : global::System.UriKind.Relative);
            }
            if (propertiesArg != null)
            {
                this.Properties = new global::System.Collections.Generic.Dictionary<string, string>(propertiesArg);
        ...
        /// <param name="helpUriArg">An initialization value for the <see cref="P:HelpUri" /> member.</param>
        /// <param name="propertiesArg">An initialization value for the <see cref="P:Properties" /> member.</param>
        /// <param name="tagArg">An initialization value for the <see cref="P:Tag" /> member.</param>
        ...
        public override int GetHashCode()
        {
            ...
            unchecked
            {
                ...
                {
                    result = (result * 31) + this.HelpUri.GetHashCode();
                }
                if (this.Properties != null)
                {
                    // Use xor for dictionaries to be order-independent
                ...
                if (this.Tag != null)
                {
                    foreach (var value_3 in this.Tag)
                    {
                        result = result * 31;
                        if (value_3 != null)
                        {
        ...
        public bool Equals(RuleDescriptor other)
        {
            ...
            if (!global::System.Object.ReferenceEquals(this.Options, other.Options))
            {
                ...
                foreach (var value_4 in this.Options)
                {
                    string value_5;
                    if (!other.Options.TryGetValue(value_4.Key, out value_5) || !global::System.Object.Equals(value_4.Value, value_5))
                    {
                        return false;
                    }
                }
            ...
            if (!global::System.Object.ReferenceEquals(this.FormatSpecifiers, other.FormatSpecifiers))
            {
                ...
                foreach (var value_6 in this.FormatSpecifiers)
                {
                    string value_7;
                    if (!other.FormatSpecifiers.TryGetValue(value_6.Key, out value_7) || !global::System.Object.Equals(value_6.Value, value_7))
                    {
                        return false;
                    }
                }
            ...
            if (!global::System.Object.ReferenceEquals(this.Properties, other.Properties))
            {
                ...
                foreach (var value_8 in this.Properties)
                {
                    string value_9;
                    if (!other.Properties.TryGetValue(value_8.Key, out value_9) || !global::System.Object.Equals(value_8.Value, value_9))
                    {
                        return false;
                    }
                }
            ...
            if (!global::System.Object.ReferenceEquals(this.Tag, other.Tag))
            {
                ...
                int max_0 = this.Tag.Count;
                for (int index_0 = 0; index_0 < max_0; ++index_0)
                {
                    var value_10 = this.Tag[index_0];
                    var value_11 = other.Tag[index_0];
                    if (value_10 != value_11)
                    {
                        return false;
                    }
                }
    ...
    public sealed class RunInfo : ISyntax, IEquatable<RunInfo>
    {
        /// <summary>Gets the kind of type implementing <see cref="ISyntax" />.</summary>
        /// <value>The enumeration value for the kind of type implementing <see cref="ISyntax" />.</value>
        public SarifKind SyntaxKind { get { return SarifKind.RunInfo; } }
        ...
        public global::System.Collections.Generic.Dictionary<string, IList<FileReference>> FileInfo { get; set; }
        ...
        public global::System.DateTime RunStartTime { get; set; }
        ...
        public global::System.DateTime RunEndTime { get; set; }
        ...
        private void Init(string invocationInfoArg, global::System.Collections.Generic.Dictionary<string, IList<FileReference>> fileInfoArg, global::System.DateTime runStartTimeArg, global::System.DateTime runEndTimeArg, string correlationIdArg, string architectureArg, global::System.Collections.Generic.Dictionary<string, string> propertiesArg, IEnumerable<string> tagArg)
        {
            ...
            if (fileInfoArg != null)
            {
                this.FileInfo = new global::System.Collections.Generic.Dictionary<string, IList<FileReference>>(fileInfoArg);
            }
            if (runStartTimeArg != null)
            {
                this.RunStartTime = runStartTimeArg;
            }
            if (runEndTimeArg != null)
            {
                this.RunEndTime = runEndTimeArg;
            }
            if (correlationIdArg != null)
            {
                this.CorrelationId = correlationIdArg;
            }
            if (architectureArg != null)
            {
                this.Architecture = architectureArg;
            }
            if (propertiesArg != null)
            {
                this.Properties = new global::System.Collections.Generic.Dictionary<string, string>(propertiesArg);
        ...
        /// <param name="fileInfoArg">An initialization value for the <see cref="P:FileInfo" /> member.</param>
        /// <param name="runStartTimeArg">An initialization value for the <see cref="P:RunStartTime" /> member.</param>
        /// <param name="runEndTimeArg">An initialization value for the <see cref="P:RunEndTime" /> member.</param>
        /// <param name="correlationIdArg">An initialization value for the <see cref="P:CorrelationId" /> member.</param>
        ...
        public override int GetHashCode()
        {
            ...
            unchecked
            {
                ...
                {
                    result = (result * 31) + this.RunStartTime.GetHashCode();
                }
                if (this.RunEndTime != null)
                {
                    result = (result * 31) + this.RunEndTime.GetHashCode();
                }
                if (this.CorrelationId != null)
                {
                    result = (result * 31) + this.CorrelationId.GetHashCode();
                }
                if (this.Architecture != null)
                {
                    result = (result * 31) + this.Architecture.GetHashCode();
                }
                if (this.Properties != null)
                {
                    // Use xor for dictionaries to be order-independent
        ...
        public bool Equals(RunInfo other)
        {
            ...
            if (!global::System.Object.ReferenceEquals(this.FileInfo, other.FileInfo))
            {
                if (this.FileInfo == null || other.FileInfo == null || this.FileInfo.Count != other.FileInfo.Count)
                {
                    return false;
                }
                foreach (var value_3 in this.FileInfo)
                {
                    IList<FileReference> value_4;
            ...
            if (this.RunStartTime != other.RunStartTime)
            {
                return false;
            }

            if (this.RunEndTime != other.RunEndTime)
            {
                return false;
            }
            ...
            if (!global::System.Object.ReferenceEquals(this.Tag, other.Tag))
            {
                ...
                for (int index_0 = 0; index_0 < max_0; ++index_0)
                {
                    var value_7 = this.Tag[index_0];
                    var value_8 = other.Tag[index_0];
                    if (value_7 != value_8)
                    {
                        return false;
                    }
    ...
    public sealed class RunLog : ISyntax, IEquatable<RunLog>
    {
        /// <summary>Gets the kind of type implementing <see cref="ISyntax" />.</summary>
        /// <value>The enumeration value for the kind of type implementing <see cref="ISyntax" />.</value>
        public SarifKind SyntaxKind { get { return SarifKind.RunLog; } }
        ...
        private void Init(ToolInfo toolInfoArg, RunInfo runInfoArg, IEnumerable<RuleDescriptor> ruleInfoArg, IEnumerable<Result> resultsArg)
        {
            if (toolInfoArg != null)
            {
            ...
            if (resultsArg != null)
            {
                ...
                if (resultsArg != null)
                {
                    foreach (var value_1 in resultsArg)
                    {
                        if (value_1 == null)
                        {
                            destination_1.Add(null);
                        ...
                        {
                            destination_1.Add(new Result(value_1));
                        }
                    }
                }

                this.Results = destination_1;
            }
        }
        ...
        public RunLog(ToolInfo toolInfoArg, RunInfo runInfoArg, IEnumerable<RuleDescriptor> ruleInfoArg, IEnumerable<Result> resultsArg)
        {
            this.Init(
                toolInfoArg, 
                runInfoArg, 
        ...
        public override int GetHashCode()
        {
            ...
            unchecked
            {
                ...
                {
                    foreach (var value_1 in this.Results)
                    {
                        result = result * 31;
                        if (value_1 != null)
                        {
        ...
        public bool Equals(RunLog other)
        {
            ...
            if (!global::System.Object.ReferenceEquals(this.RuleInfo, other.RuleInfo))
            {
                ...
                for (int index_0 = 0; index_0 < max_0; ++index_0)
                {
                    var value_2 = this.RuleInfo[index_0];
                    var value_3 = other.RuleInfo[index_0];
                    if (!global::System.Object.Equals(value_2, value_3))
                    {
                        return false;
                    }
                }
            ...
            if (!global::System.Object.ReferenceEquals(this.Results, other.Results))
            {
                ...
                int max_1 = this.Results.Count;
                for (int index_1 = 0; index_1 < max_1; ++index_1)
                {
                    var value_4 = this.Results[index_1];
                    var value_5 = other.Results[index_1];
    ...
    public sealed class ToolInfo : ISyntax, IEquatable<ToolInfo>
    {
        /// <summary>Gets the kind of type implementing <see cref="ISyntax" />.</summary>
        /// <value>The enumeration value for the kind of type implementing <see cref="ISyntax" />.</value>
        public SarifKind SyntaxKind { get { return SarifKind.ToolInfo; } }
    ...
    /// <summary>Visitor for a Sarif tree.</summary>
    public abstract class SarifVisitor<T>
    {
        /// <summary>Starts a visit of a Sarif tree.</summary>
        ...
        /// <summary>Visits a AnnotatedCodeLocation node in a Sarif tree.</summary>
        ...
        public virtual T VisitAnnotatedCodeLocation(AnnotatedCodeLocation node)
        {
            if (node != null)
            {
                this.VisitNullChecked(node.PhysicalLocation);
            }

            return (T)(object)node;
        }

        /// <summary>Visits a FileChange node in a Sarif tree.</summary>
        ...
        /// <summary>Visits a FileReference node in a Sarif tree.</summary>
        ...
        /// <summary>Visits a Fix node in a Sarif tree.</summary>
        ...
        /// <summary>Visits a FormattedMessage node in a Sarif tree.</summary>
        ...
        /// <summary>Visits a Hash node in a Sarif tree.</summary>
        ...
        /// <summary>Visits a Location node in a Sarif tree.</summary>
        /// <param name="node">A Location node to visit.</param>
        public virtual T VisitLocation(Location node)
        {
            if (node != null)
            {
                this.VisitNullChecked(node.AnalysisTarget);
                this.VisitNullChecked(node.ResultFile);
        ...
        /// <summary>Visits a LogicalLocationComponent node in a Sarif tree.</summary>
        ...
        /// <summary>Visits a PhysicalLocation node in a Sarif tree.</summary>
        /// <param name="node">A PhysicalLocation node to visit.</param>
        public virtual T VisitPhysicalLocation(PhysicalLocation node)
        {
            if (node != null)
            {
        ...
        /// <summary>Visits a Region node in a Sarif tree.</summary>
        ...
        /// <summary>Visits a Replacement node in a Sarif tree.</summary>
        ...
        /// <summary>Visits a Result node in a Sarif tree.</summary>
        ...
        /// <summary>Visits a ResultLog node in a Sarif tree.</summary>
        ...
        /// <summary>Visits a RuleDescriptor node in a Sarif tree.</summary>
        ...
        /// <summary>Visits a RunInfo node in a Sarif tree.</summary>
        ...
        public virtual T VisitRunInfo(RunInfo node)
        {
            if (node != null)
            {
                if (node.FileInfo != null)
                {
                    ...
                    {
                        IList<FileReference> fileReferences = node.FileInfo[uri];
        ...
        /// <summary>Visits a RunLog node in a Sarif tree.</summary>
        ...
        /// <summary>Visits a ToolInfo node in a Sarif tree.</summary>
    ...
    public abstract class SarifRewritingVisitor
    {
        ...
        /// <summary>Rewrites a ResultLog node in a Sarif tree.</summary>
        /// <param name="node">A ResultLog node to visit.</param>
