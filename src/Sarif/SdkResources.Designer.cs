...
namespace Microsoft.CodeAnalysis.Sarif {
    ...
    internal class SdkResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Rule &apos;{0}&apos; was explicitly disabled by the user. As result, this tool run cannot be used to for compliance or other auditing processes that require a comprehensive analysis..
        /// </summary>
