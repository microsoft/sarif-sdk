...
namespace Microsoft.CodeAnalysis.Sarif {
    ...
    public class SdkResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to One or more targets was skipped entirely as it was determined to be an invalid target for analysis. Include &apos;NotApplicable&apos; on an explicit &apos;--kind&apos; command-line argument (e.g., &apos;--kind Fail;NotApplicable&apos;) for more information..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to One or more rules was disabled for an analysis target, as it was determined not to be applicable to it (this is a common condition). Include &apos;Note&apos; on an explicit &apos;--level &apos; command-line argument (e.g., &apos;--level Error;Warning;Note&apos;) for more information..
        /// </summary>
