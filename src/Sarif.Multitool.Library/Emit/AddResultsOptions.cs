...
{
    /// <summary>
    /// Options for <c>add-results</c>, which appends one or more fully-formed SARIF <c>result</c>
    ...
    /// </remarks>
    [Verb("add-results", HelpText = "Append one or more fully-formed SARIF results (JSON object or array) to a staged event log.")]
