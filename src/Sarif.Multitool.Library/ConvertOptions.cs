...
namespace Microsoft.CodeAnalysis.Sarif.Multitool
{
    ...
    public class ConvertOptions : SingleFileOptionsBase
    {
        [Option(
            't',
            "tool",
            HelpText = "The tool format of the input file. Must be one of: AndroidStudio, ClangAnalyzer, CppCheck, ContrastSecurity, FlawFinder, Hdf, Fortify, FortifyFpr, FxCop, PREfast, Pylint, SemmleQL, StaticDriverVerifier, TSLint, or a tool format for which a plugin assembly provides the converter.",
            Required = true)]
