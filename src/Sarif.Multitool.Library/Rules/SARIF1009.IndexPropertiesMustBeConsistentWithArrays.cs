...
namespace Microsoft.CodeAnalysis.Sarif.Multitool.Rules
{
    public class IndexPropertiesMustBeConsistentWithArrays : SarifValidationSkimmerBase
    {
        public IndexPropertiesMustBeConsistentWithArrays() : base(
            RuleId.IndexPropertiesMustBeConsistentWithArrays,
            RuleResources.SARIF1009_IndexPropertiesMustBeConsistentWithArrays_FullDescription_Text,
            FailureLevel.Error,
            new string[] { nameof(RuleResources.SARIF1009_IndexPropertiesMustBeConsistentWithArrays_Error_TargetArrayMustExist_Text), nameof(RuleResources.SARIF1009_IndexPropertiesMustBeConsistentWithArrays_Error_TargetArrayMustBeLongEnough_Text) }
            )
        { }
