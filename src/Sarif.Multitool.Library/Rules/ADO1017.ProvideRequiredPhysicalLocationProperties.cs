...
namespace Microsoft.CodeAnalysis.Sarif.Multitool.Rules
{
        ...
        : BaseProvideRequiredResultProperties
    {
        ...
        public override MultiformatMessageString FullDescription => new() { Text = RuleResources.ADO1017_ProvideRequiredPhysicalLocationProperties_FullDescription_Text };
