...
namespace Microsoft.CodeAnalysis.Sarif.Multitool.Rules
{
    ...
    public class ProvideContextRegion : SarifValidationSkimmerBase
    {
        public ProvideContextRegion() : base(
            RuleId.ProvideContextRegion,
            RuleResources.SARIF2011_ProvideContextRegion_FullDescription_Text,
            FailureLevel.Note,
            new string[] { nameof(RuleResources.SARIF2011_ProvideContextRegion_Note_Default_Text) }
        )
        { }
