...
namespace Microsoft.CodeAnalysis.Sarif.Multitool.Rules
{
    ...
    public class UrisShouldBeReachable : SarifValidationSkimmerBase
    {
        public UrisShouldBeReachable() : base(
            RuleId.UrisShouldBeReachable,
            RuleResources.SARIF2006_UrisShouldBeReachable_FullDescription_Text,
            FailureLevel.Note,
            new string[] { nameof(RuleResources.SARIF2006_UrisShouldBeReachable_Note_Default_Text) }
        )
        { }
