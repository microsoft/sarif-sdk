...
{
    public class GHAzDOProvideRequiredLocationProperties
        : BaseProvideRequiredLocationProperties
    {
        /// <summary>
        /// GHAzDO1016
        /// </summary>
        public override string Id => RuleId.GHAzDOProvideRequiredLocationProperties;

        public override MultiformatMessageString FullDescription => new MultiformatMessageString() { Text = RuleResources.GHAzDO1016_ProvideRequiredLocationProperties_FullDescription_Text };
        ...
        public GHAzDOProvideRequiredLocationProperties()
        {
