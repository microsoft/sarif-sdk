...
namespace Microsoft.CodeAnalysis.Sarif.Multitool.Rules
{
    ...
    public class ProvideMessageArguments : SarifValidationSkimmerBase
    {
        public ProvideMessageArguments() : base(
            RuleId.ProvideMessageArguments,
            RuleResources.SARIF2002_ProvideMessageArguments_FullDescription_Text,
            FailureLevel.Note,
            new string[] { nameof(RuleResources.SARIF2002_ProvideMessageArguments_Note_Default_Text) }
        )
        { }
