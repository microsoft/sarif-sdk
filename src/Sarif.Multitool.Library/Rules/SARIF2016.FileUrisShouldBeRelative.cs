...
namespace Microsoft.CodeAnalysis.Sarif.Multitool.Rules
{
    ...
    public class FileUrisShouldBeRelative : SarifValidationSkimmerBase
    {
        public FileUrisShouldBeRelative() : base(
            RuleId.FileUrisShouldBeRelative,
            RuleResources.SARIF2016_FileUrisShouldBeRelative_FullDescription_Text,
            FailureLevel.Note,
            new string[] { nameof(RuleResources.SARIF2016_FileUrisShouldBeRelative_Note_Default_Text) }
        )
        { }
