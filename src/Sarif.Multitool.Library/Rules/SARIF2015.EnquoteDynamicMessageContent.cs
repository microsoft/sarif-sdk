...
namespace Microsoft.CodeAnalysis.Sarif.Multitool.Rules
{
    ...
    {
        public EnquoteDynamicMessageContent() : base(
            RuleId.EnquoteDynamicMessageContent,
            RuleResources.SARIF2015_EnquoteDynamicMessageContent_FullDescription_Text,
            FailureLevel.Note,
            new string[] { nameof(RuleResources.SARIF2015_EnquoteDynamicMessageContent_Note_Default_Text) }
        )
        { }
