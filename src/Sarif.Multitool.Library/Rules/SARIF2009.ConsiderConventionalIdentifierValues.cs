...
namespace Microsoft.CodeAnalysis.Sarif.Multitool.Rules
{
    ...
    public class ConsiderConventionalIdentifierValues : SarifValidationSkimmerBase
    {
        public ConsiderConventionalIdentifierValues() : base(
            RuleId.ConsiderConventionalIdentifierValues,
            RuleResources.SARIF2009_ConsiderConventionalIdentifierValues_FullDescription_Text,
            FailureLevel.Note,
            new string[] { nameof(RuleResources.SARIF2009_ConsiderConventionalIdentifierValues_Note_UseConventionalRuleIds_Text) }
        )
        { }
