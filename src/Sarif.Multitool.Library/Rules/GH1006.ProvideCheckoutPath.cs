...
namespace Microsoft.CodeAnalysis.Sarif.Multitool.Rules
{
    ...
    public class ProvideCheckoutPath : SarifValidationSkimmerBase
    {
        public ProvideCheckoutPath() : base(
            RuleId.ProvideCheckoutPath,
            RuleResources.GH1006_ProvideCheckoutPath_FullDescription_Text,
            FailureLevel.Error,
            new string[] { nameof(RuleResources.GH1006_ProvideCheckoutPath_Error_Default_Text) },
