...
namespace Microsoft.CodeAnalysis.Sarif.Multitool.Rules
{
    ...
    public class ProvideDynamicMessageContent : SarifValidationSkimmerBase
    {
        public ProvideDynamicMessageContent() : base(
            ...
            RuleResources.SARIF2014_ProvideDynamicMessageContent_FullDescription_Text,
            FailureLevel.Note,
            new string[] { nameof(RuleResources.SARIF2014_ProvideDynamicMessageContent_Note_Default_Text) }
        )
        { }
