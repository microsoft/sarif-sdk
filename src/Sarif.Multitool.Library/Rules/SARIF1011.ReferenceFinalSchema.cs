...
namespace Microsoft.CodeAnalysis.Sarif.Multitool.Rules
{
    ...
    public class ReferenceFinalSchema : SarifValidationSkimmerBase
    {
        public ReferenceFinalSchema() : base(
            RuleId.ReferenceFinalSchema,
            RuleResources.SARIF1011_ReferenceFinalSchema_FullDescription_Text,
            FailureLevel.Error,
            new string[] { nameof(RuleResources.SARIF1011_ReferenceFinalSchema_Error_Default_Text) }
        )
        { }
