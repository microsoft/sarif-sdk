...
namespace Microsoft.CodeAnalysis.Sarif.Multitool.Rules
{
    ...
    {
        public TerminateMessagesWithPeriod() : base(
            RuleId.TerminateMessagesWithPeriod,
            RuleResources.SARIF2001_TerminateMessagesWithPeriod_FullDescription_Text,
            FailureLevel.Warning,
            new string[] { nameof(RuleResources.SARIF2001_TerminateMessagesWithPeriod_Warning_Default_Text) }
        )
        { }
