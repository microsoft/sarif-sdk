...
namespace Microsoft.CodeAnalysis.Sarif.Multitool.Rules
{
    ...
    public class ReviewArraysThatExceedConfigurableDefaults : SarifValidationSkimmerBase
    {
        public ReviewArraysThatExceedConfigurableDefaults() : base(
            RuleId.ReviewArraysThatExceedConfigurableDefaults,
            RuleResources.GH1004_ReviewArraysThatExceedConfigurableDefaults_FullDescription_Text,
            FailureLevel.Error,
            new string[] { nameof(RuleResources.GH1004_ReviewArraysThatExceedConfigurableDefaults_Error_Default_Text) },
