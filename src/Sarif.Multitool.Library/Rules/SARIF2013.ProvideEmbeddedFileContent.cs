...
namespace Microsoft.CodeAnalysis.Sarif.Multitool.Rules
{
    ...
    public class ProvideEmbeddedFileContent : SarifValidationSkimmerBase
    {
        public ProvideEmbeddedFileContent() : base(
            RuleId.ProvideEmbeddedFileContent,
            RuleResources.SARIF2013_ProvideEmbeddedFileContent_FullDescription_Text,
            FailureLevel.Note,
            new string[] { nameof(RuleResources.SARIF2013_ProvideEmbeddedFileContent_Note_Default_Text) }
        )
        { }
