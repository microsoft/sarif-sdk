...
{
    public class GHAzDOProvideRequiredReportingDescriptorProperties
        : BaseProvideRequiredReportingDescriptorProperties
    {
        /// <summary>
        /// GHAzDO2012
        /// </summary>
        public override string Id => RuleId.GHAzDOProvideRequiredReportingDescriptorProperties;

        public override MultiformatMessageString FullDescription => new MultiformatMessageString { Text = RuleResources.GHAzDO2012_ProvideRequiredReportingDescriptorProperties_FullDescription_Text };

        private readonly List<string> _messageResourceNames = new List<string>()
        {
            nameof(RuleResources.GHAzDO2012_ProvideRequiredResultProperties_Error_MissingName_Text)
        };
        ...
        public GHAzDOProvideRequiredReportingDescriptorProperties()
        {
