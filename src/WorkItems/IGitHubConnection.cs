...
{
    /// <summary>
    /// This interface allows for mocking of the low-level Gitjub connection class.
    /// </summary>
    internal interface IGitHubConnection
    {
        ...
        /// </summary>
        /// <param name="organization">The AzureDevOps account URI for the connection.</param>
