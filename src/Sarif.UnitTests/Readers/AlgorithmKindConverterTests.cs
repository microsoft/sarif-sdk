...
namespace Microsoft.CodeAnalysis.Sarif.Readers
{
    ...
    public class AlgorithmKindConverterTests
    {
        ...
        {
            string expected = "{\"version\":\"0.4\",\"runLogs\":[{\"toolInfo\":{\"name\":null},\"runInfo\":{\"analysisTargets\":[{\"uri\":null,\"hashes\":[{\"value\":null,\"algorithm\":\"Grøstl\"}]}]},\"results\":[{\"ruleId\":null,\"locations\":null}]}]}";
