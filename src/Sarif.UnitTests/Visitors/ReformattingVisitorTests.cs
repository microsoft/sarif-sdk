...
namespace Microsoft.CodeAnalysis.Sarif.Visitors
{
    public class ReformattingVisitorTests
    {
        ...
        private static string s_testText = "line1\r\nline2\r\nline3\r\nline4";

        private static Tuple<Region, string>[] s_testCases = new Tuple<Region, string>[]
        {
        ...
        [Fact]        
        public void ReformattingVisitor_InsertCodeSnippets()
        {
            foreach (Tuple<Region, string> tuple in s_testCases)
            {
                ...
                if (expectedResult != null)
                {
                    ...
                    region.Snippet.Text.Should().Be(tuple.Item2);
                }
                else
                {
