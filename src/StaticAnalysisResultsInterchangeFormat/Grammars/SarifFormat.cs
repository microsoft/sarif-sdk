...
//     Input Grammar      : ToolResultsLog
//     Input Grammar file : D:\src\sarif-sdk-ms\src\StaticAnalysisResultsInterchangeFormat\GrammarFiles\SarifFormat.g4
//     
...
namespace Microsoft.CodeAnalysis.StaticAnalysisResultsInterchangeFormat.DataContracts
{
    ...
    public enum ToolResultsLogKind
    {
    ...
    /// <summary>An interface for all types generated from the grammar ToolResultsLog.</summary>
    ...
    public sealed class AnnotatedCodeLocation : ISyntax, IEquatable<AnnotatedCodeLocation>
    {
        ...
        public AnnotatedCodeLocation(IEnumerable<IEnumerable<PhysicalLocationComponent>> physicalLocationsArg, string messageArg)
        {
            this.Init(
    ...
    public sealed class Location : ISyntax, IEquatable<Location>
    {
        ...
        private void Init(IEnumerable<PhysicalLocationComponent> analysisTargetArg, IEnumerable<PhysicalLocationComponent> issueFileArg, IEnumerable<LogicalLocationComponent> logicalLocationArg, string fullyQualifiedLogicalNameArg, global::System.Collections.Generic.Dictionary<string, string> propertiesArg)
        {
        ...
        public Location(IEnumerable<PhysicalLocationComponent> analysisTargetArg, IEnumerable<PhysicalLocationComponent> issueFileArg, IEnumerable<LogicalLocationComponent> logicalLocationArg, string fullyQualifiedLogicalNameArg, global::System.Collections.Generic.Dictionary<string, string> propertiesArg)
        {
            this.Init(
                analysisTargetArg, 
                issueFileArg, 
    ...
    public sealed class RunInfo : ISyntax, IEquatable<RunInfo>
    {
        ...
        /// </summary>
        [DataMember(Name="parameterization", IsRequired = true)]
        public string Parameterization { get; set; }
        ...
        private void Init(string parameterizationArg, IEnumerable<FileReference> analysisTargetsArg)
        {
            if (parameterizationArg != null)
            {
                this.Parameterization = parameterizationArg;
            }
        ...
        /// <param name="parameterizationArg">An initialization value for the <see cref="P:Parameterization" /> member.</param>
        /// <param name="analysisTargetsArg">An initialization value for the <see cref="P:AnalysisTargets" /> member.</param>
        public RunInfo(string parameterizationArg, IEnumerable<FileReference> analysisTargetsArg)
        {
            this.Init(
                parameterizationArg, 
                analysisTargetsArg
        ...
        public override int GetHashCode()
        {
            ...
            unchecked
            {
                ...
                {
                    result = (result * 31) + this.Parameterization.GetHashCode();
                }
    ...
    /// <summary>Visitor for a ToolResultsLog tree.</summary>
    public abstract class ToolResultsLogVisitor<T>
    {
        /// <summary>Starts a visit of a ToolResultsLog tree.</summary>
        ...
        /// <summary>Executes a visit of a ToolResultsLog tree.</summary>
        /// <param name="node">The node to visit.</param>
        public virtual T VisitActual(ISyntax node)
        {
            ...
            case ToolResultsLogKind.ToolInfo:
        ...
        /// <summary>Visits a AnnotatedCodeLocation node in a ToolResultsLog tree.</summary>
        ...
        /// <summary>Visits a FileChange node in a ToolResultsLog tree.</summary>
        ...
        /// <summary>Visits a FileReference node in a ToolResultsLog tree.</summary>
        ...
        /// <summary>Visits a Fix node in a ToolResultsLog tree.</summary>
        ...
        /// <summary>Visits a Hash node in a ToolResultsLog tree.</summary>
        ...
        /// <summary>Visits a Location node in a ToolResultsLog tree.</summary>
        ...
        /// <summary>Visits a LogicalLocationComponent node in a ToolResultsLog tree.</summary>
        ...
        /// <summary>Visits a PhysicalLocationComponent node in a ToolResultsLog tree.</summary>
        ...
        /// <summary>Visits a Region node in a ToolResultsLog tree.</summary>
        ...
        /// <summary>Visits a Replacement node in a ToolResultsLog tree.</summary>
        ...
        /// <summary>Visits a Result node in a ToolResultsLog tree.</summary>
        ...
        /// <summary>Visits a RunInfo node in a ToolResultsLog tree.</summary>
        ...
        /// <summary>Visits a RunLog node in a ToolResultsLog tree.</summary>
        ...
        /// <summary>Visits a ToolInfo node in a ToolResultsLog tree.</summary>
    ...
    /// <summary>Rewriting visitor for a ToolResultsLog tree.</summary>
    public abstract class ToolResultsLogRewritingVisitor
    {
        /// <summary>Starts a rewriting visit of a ToolResultsLog tree.</summary>
        ...
        /// <summary>Rewrites a AnnotatedCodeLocation node in a ToolResultsLog tree.</summary>
        /// <param name="node">A AnnotatedCodeLocation node to visit.</param>
        ...
        /// <summary>Rewrites a FileChange node in a ToolResultsLog tree.</summary>
        /// <param name="node">A FileChange node to visit.</param>
        ...
        /// <summary>Rewrites a FileReference node in a ToolResultsLog tree.</summary>
        /// <param name="node">A FileReference node to visit.</param>
        ...
        /// <summary>Rewrites a Fix node in a ToolResultsLog tree.</summary>
        /// <param name="node">A Fix node to visit.</param>
        ...
        /// <summary>Rewrites a Hash node in a ToolResultsLog tree.</summary>
        /// <param name="node">A Hash node to visit.</param>
        ...
        /// <summary>Rewrites a Location node in a ToolResultsLog tree.</summary>
        /// <param name="node">A Location node to visit.</param>
        ...
        /// <summary>Rewrites a LogicalLocationComponent node in a ToolResultsLog tree.</summary>
        /// <param name="node">A LogicalLocationComponent node to visit.</param>
        ...
        /// <summary>Rewrites a PhysicalLocationComponent node in a ToolResultsLog tree.</summary>
        /// <param name="node">A PhysicalLocationComponent node to visit.</param>
        ...
        /// <summary>Rewrites a Region node in a ToolResultsLog tree.</summary>
        /// <param name="node">A Region node to visit.</param>
        ...
        /// <summary>Rewrites a Replacement node in a ToolResultsLog tree.</summary>
        /// <param name="node">A Replacement node to visit.</param>
        ...
        /// <summary>Rewrites a Result node in a ToolResultsLog tree.</summary>
        /// <param name="node">A Result node to visit.</param>
        ...
        /// <summary>Rewrites a RunInfo node in a ToolResultsLog tree.</summary>
        /// <param name="node">A RunInfo node to visit.</param>
        ...
        /// <summary>Rewrites a RunLog node in a ToolResultsLog tree.</summary>
        /// <param name="node">A RunLog node to visit.</param>
        ...
        /// <summary>Rewrites a ToolInfo node in a ToolResultsLog tree.</summary>
        /// <param name="node">A ToolInfo node to visit.</param>
