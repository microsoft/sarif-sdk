...
namespace Microsoft.CodeAnalysis.Sarif.Multitool
{
    public class ValidateCommandTests : FileDiffingFunctionalTests
    {
        ...
        [Fact]
        public void GitHub1001_ProvideRequiredLocationProperties_Valid()
            => RunValidTestForRule(RuleId.ProvideRequiredLocationProperties);

        [Fact]
        public void GitHub1001_ProvideRequiredLocationProperties_Invalid()
            => RunInvalidTestForRule(RuleId.ProvideRequiredLocationProperties);

        [Fact]
        public void GitHub1002_InlineThreadFlowLocations_Valid()
            => RunValidTestForRule(RuleId.InlineThreadFlowLocations);

        [Fact]
        public void GitHub1002_InlineThreadFlowLocations_Invalid()
            => RunInvalidTestForRule(RuleId.InlineThreadFlowLocations);

        [Fact]
        public void GitHub1003_ProvideRequiredRegionProperties_Valid()
            => RunValidTestForRule(RuleId.ProvideRequiredRegionProperties);

        [Fact]
        public void GitHub1003_ProvideRequiredRegionProperties_Invalid()
            => RunInvalidTestForRule(RuleId.ProvideRequiredRegionProperties);

        [Fact]
        public void GitHub1004_ReviewArraysThatExceedConfigurableDefaults_Valid()
            => RunArrayLimitTest(ValidTestFileNameSuffix);

        [Fact]
        public void GitHub1004_ReviewArraysThatExceedConfigurableDefaults_Invalid()
            => RunArrayLimitTest(InvalidTestFileNameSuffix);

        [Fact]
        public void GitHub1005_LocationsMustBeRelativeUrisOrFilePaths_Valid()
            => RunValidTestForRule(RuleId.LocationsMustBeRelativeUrisOrFilePaths);

        [Fact]
        public void GitHub1005_LocationsMustBeRelativeUrisOrFilePaths_Invalid()
            => RunInvalidTestForRule(RuleId.LocationsMustBeRelativeUrisOrFilePaths);

        [Fact]
        public void GitHub1006_ProvideCheckoutPath_Valid()
            => RunValidTestForRule(RuleId.ProvideCheckoutPath);

        [Fact]
        public void GitHub1006_ProvideCheckoutPath_Invalid()
            => RunInvalidTestForRule(RuleId.ProvideCheckoutPath);

        [Fact]
        public void GitHub1007_ProvideRequiredRelatedLocationProperties_Valid()
            => RunValidTestForRule(RuleId.ProvideRequiredRelatedLocationProperties);

        [Fact]
        public void GitHub1007_ProvideRequiredRelatedLocationProperties_Invalid()
        ...
        private static bool IsSarifRule(string ruleId)
            => ruleId.StartsWith("SARIF") || ruleId.StartsWith("GitHub");
