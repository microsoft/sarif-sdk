...
* FEATURE: Log additional debugging information for analyze command when provided `--verbose`, or when provided `--level` value including `note`. [#2590](https://github.com/microsoft/sarif-sdk/pull/2590)
