...
* BREAKING: `absoluteAddress` property of `address` changed from `int`(32bit) to `BigInteger`(unlimited) to fix `Newtonsoft.Json.JsonReaderException: JSON integer XXXXX is too large or small for an Int32.` [#2502](https://github.com/microsoft/sarif-sdk/pull/2502)
