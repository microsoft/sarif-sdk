...
* API BREAKING: Remove 'run.resources' object. Rename 'rule' object to 'reportingDescriptor'. Move rule and notification message descriptor objects to 'tool.notificationDescriptors' and 'tool.ruleDescriptors'. 'resources.messageStrings' now located at 'tool.globalMessageStrings'. 'rule.configuration' property now named 'reportingDescriptor.defaultConfiguration'. 'ruleConfiguration.defaultLevel' and 'ruleConfiguration.defaultRank' simplified to 'ruleConfiguration.level' and 'ruleConfiguration.rank'. Actual rules configuration persisted to new array of ruleConfiguration objects at 'invocation.ruleConfiguration'. https://github.com/oasis-tcs/sarif-spec/issues/311
