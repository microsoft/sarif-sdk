...
* BUGFIX: Properly report JSON1006.ValueTooLarge in the results node when validating Sarif file with Location.Id bigger than Int32.MaxValue. [#2439](https://github.com/microsoft/sarif-sdk/pull/2439)
