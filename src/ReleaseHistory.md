...
* API BREAKING: The Init methods in the Autogenerated SARIF object model classes are now virtual. This enables derived classes to add additional properties without having to copy the entire code of the Init method.