...
* FEATURE: Log additional debugging information for analyze command when provided `--level` value includes `none`. [#2590](https://github.com/microsoft/sarif-sdk/pull/2590)
