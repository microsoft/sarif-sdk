...
* BUGFIX: Properly report `JSON1006.ValueTooLarge` in the `results` node when validating a SARIF file with `id` of `location` greater than Int32.MaxValue. [#2441](https://github.com/microsoft/sarif-sdk/pull/2441)
