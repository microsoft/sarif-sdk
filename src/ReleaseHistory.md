...
* BUGFIX: ESLint SARIF formatter couple improvements for Github code scanning alerts: generates region endLine/endColumn properties, adds rule help text, remove markdown syntax from rule short description which alert page does not support.
