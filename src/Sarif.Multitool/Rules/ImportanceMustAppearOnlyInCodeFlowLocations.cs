...
namespace Microsoft.CodeAnalysis.Sarif.Multitool.Rules
{
    ...
    {
        public override string FullDescription => RuleResources.SARIF1011_ImportanceMustAppearOnlyInCodeFlowLocations;
        ...
        protected override IEnumerable<string> FormatIds
        {
            get
            {
                return new string[]
                {
                    nameof(RuleResources.SARIF1011_Default)
                };
            }
        }
        ...
        protected override void Analyze(AnnotatedCodeLocation annotatedCodeLocation, string annotatedCodeLocationPointer)
        {
            ...
            if (token.HasProperty(SarifPropertyName.Importance))
            {
                if (!annotatedCodeLocationPointer.Contains(SarifPropertyName.CodeFlows))
                {
                    ...
                    LogResult(importancePointer, nameof(RuleResources.SARIF1011_Default));
                }
            }
        }
    }
